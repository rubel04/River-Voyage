...
const AdventureDetails = () => {
  ...
  return (
    <div className="mt-10">
      <div>
        <img
          className="w-1/2 md:h-[500px] object-cover my-4"
          src={image}
          alt={`${title} img`}
        />
      </div>
      ...
      <p className="text-lg text-gray-200 font-semibold mt-4 mb-2">
        Description:{" "}
      ...
      <button
        ...
        className="px-4 mt-8 md:px-8 py-1 md:py-3 font-medium cursor-pointer  hover:bg-white hover:text-purple-500 bg-purple-500 text-white transition duration-300"
      >
        Talk With Expert
      </button>
    </div>
